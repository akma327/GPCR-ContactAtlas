...
# Date: 04/29/17
# batch_static_contacts_homology_models.py
...
STATIC_CONTACTS_HM_PATH="/scratch/PI/rondror/akma327/GPCRContacts/data/static-contacts/homology-models"
...
def compute_homology_model_contacts():
	...
	for i, hm_pdb_path in enumerate(hadded_hm_paths):
		...
		calc_command = "python StaticInteractionCalculator.py " + hm_pdb_path + " " +  output_contacts + " -interlist -all"
