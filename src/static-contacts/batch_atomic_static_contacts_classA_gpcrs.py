...
def compute_classA_gpcr_contacts():
	...
	for i, gpcr_pdb_path in enumerate(hadded_gpcr_paths):
		...
		for line in f:
			...
			resatom1, resatom2 = atom1.split("-"), atom2.split("-")
			...
			gpcrdb1, gpcrdb2, resi1, resi2, atom1, atom2 = orderGpcrdbsAndResiAndAtom(gpcrdb1, gpcrdb2, resi1, resi2, atom1, atom2)
			key = (gpcrdb1, gpcrdb2, resi1, resi2, atom1, atom2)
		...
		for contact_type in contact_type_to_edges:
			for gpcrdb1, gpcrdb2, resi1, resi2, atom1, atom2 in contact_type_to_edges[contact_type]:
				fw.write(gpcrdb1 + "\t" + gpcrdb2 + "\t" + resi1 + "\t" + resi2 + "\t" + atom1 + "\t" + atom2 + "\t" + contact_type + "\n")
